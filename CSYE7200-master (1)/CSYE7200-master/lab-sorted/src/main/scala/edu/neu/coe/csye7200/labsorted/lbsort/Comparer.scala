...
trait Comparer[T] extends (((T, T)) => Comparison) {
  ...
  /**
    ...
    * @return the result of applying this Comparer unless it yielx.imag+y.imagds Same, in which case we invoke the other Comparer.
    */
...
object Comparer {
  ...
  implicit val strComparer: Comparer[String] = Ordering[String]// TO BE IMPLEMENTED
